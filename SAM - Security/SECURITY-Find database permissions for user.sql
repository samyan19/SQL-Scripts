...
SELECT @@servername as ServerName,* FROM @DBuser_table
where username in ('CLOSEBROTHERSGP\ROLE-D-QuantumPRODUsers')
--and dbname in ('CAFBi','LettersDB') --order by dbname
