SELECT DISTINCT db_name() as database_name, o.name, i.name, ddips.index_depth, ddips.index_level
...
Join sys.dm_db_index_physical_stats(DB_ID(),Null, Null, Null, N'Detailed') AS ddips
